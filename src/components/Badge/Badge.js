...
export const Badge = ({ color = "neutral", soft = true, className, ...props }) => (_jsx("span", { "data-slot": "badge.root", className: clsx("inline-flex items-center rounded-full px-2.5 py-0.5 text-[length:var(--text-xs)] font-medium", soft ? softMap[color] : solid[color], className), ...props }));
