    ...
    >
      ...
      >
        ...
        <div className="relative" ref={menuRef}>
          ...
          {/* 메뉴 드롭다운 */}
          {isMenuOpen && (
            <div className="absolute right-0 top-full mt-1 w-[36rem] rounded-[var(--radius-md)] border border-[color:var(--chatdock-border-subtle)] bg-[color:var(--chatdock-bg-elev-1)] shadow-lg overflow-hidden z-50">
              {/* AI 명령어 섹션 */}
