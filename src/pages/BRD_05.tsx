...
export default function PostShow() {
  ...
  return (
    <main
      className="w-full min-h-[800px] mx-auto px-6 py-8 bg-[color:var(--color-bg-elev-1)] mt-[100px]"
    ...
    >
      ...
      >
        ...
        >
          ...
          <h1 id="title" className="flex-1 text-2xl font-extrabold text-[color:var(--color-fg-primary)] break-words">
            {post.title}
          </h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-[color:var(--color-bg-elev-2)] border border-[color:var(--color-border-subtle)] rounded-lg px-3 py-2 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[color:var(--color-accent)] disabled:opacity-50 disabled:cursor-not-allowed text-sm"
        ...
        <div className="relative mt-4">
          <div
            className={`text-base text-[color:var(--color-fg-primary)] leading-relaxed ${
