...
- [x] **마이페이지 (PRF_10)** ✅ 완료 (2025-11-15)
  - [x] 프로필 조회
  - [x] 프로필 수정 (닉네임, 프로필 이미지)
  - [x] **내 마이페이지 조회** ✅ 백엔드 완료 (2025-11-15)
    - [x] 프론트엔드 API 연동 (/my-page 엔드포인트, useMyPage 훅)
    - [x] 타입 정의 (MyPageResponse, MyPagePost, MyPageComment)
    - [x] UI 구현 (PRF_10.tsx - 사용자 정보, 통계, 내 게시글/댓글/좋아요 글 최근 5건)
  - [x] **좋아요 누른 글 조회** ✅ 백엔드 완료 (최근 5건)
    - [x] 프론트엔드 API 연동 (MyPageResponse.likedPosts)
  - [x] **내가 작성한 게시글 목록** ✅ 백엔드 완료 (최근 5건)
    - [x] 프론트엔드 API 연동 (MyPageResponse.recentPosts)
  - [x] **내가 작성한 댓글 목록** ✅ 백엔드 완료 (최근 5건)
    - [x] 프론트엔드 API 연동 (MyPageResponse.recentComments)
  - [ ] 나와 관련된 책 관련 게시글 ⚠️ 우선순위 낮음
  - [x] 비밀번호 변경 ✅ 완료 (SET_13.tsx)
